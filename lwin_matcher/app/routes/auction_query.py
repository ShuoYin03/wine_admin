...
async def auction(auction_id: str) -> Response:
    try:
        ...
        return json_response(data.model_dump(mode='json'))
...
async def auctions() -> Response:
    try:
        ...
        if request.method == 'GET':
            ...
            return json_response([a.model_dump(mode='json') for a in data], count=count)
        ...
        return json_response(auctions, count=count)
